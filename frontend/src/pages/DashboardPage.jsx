  ...
  return (
    <Layout>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Bienvenido al sistema de gestión GPC</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardBody>
              ...
              <p className="text-gray-600 text-sm mt-2">Total de productos registrados</p>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              <p className="text-4xl font-bold text-primary-600">{stats.totalSegments}</p>
              <p className="text-gray-600 text-sm mt-2">Categorías GPC disponibles</p>
            </CardBody>
          </Card>
